...
from one_camera_mapping.common import StereoCalibration
...
class FusionNode(Node):
    def __init__(self):
        ...
        self.create_subscription(Image, "/depth/image_raw", self._on_depth, qos)
        self.create_subscription(
            Detection2DArray, "/detections_2d", self._on_detections, 10
        )
        self.get_logger().info("fusion_node basladi.")
